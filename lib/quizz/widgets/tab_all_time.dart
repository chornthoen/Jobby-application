...
import 'package:jobby_application/quizz/models/leader_board_model.dart';
import 'package:jobby_application/quizz/widgets/avatar_rank.dart';
import 'package:jobby_application/quizz/widgets/item_leader_boad.dart';
import 'package:jobby_application/shared/colors/app_color.dart';

class TabAllTime extends StatefulWidget {
  const TabAllTime({Key? key}) : super(key: key);

  @override
  State<TabAllTime> createState() => _TabAllTimeState();
}

class _TabAllTimeState extends State<TabAllTime> {
  @override
