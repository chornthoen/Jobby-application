...
import 'package:jobby_application/candidate/account/views/about_jobby_page.dart';
import 'package:jobby_application/candidate/account/views/account_setting_page.dart';
...
import 'package:jobby_application/candidate/account/views/change_acount_page.dart';
...
import 'package:jobby_application/candidate/account/views/id_identification_page.dart';
import 'package:jobby_application/candidate/account/views/language_page.dart';
import 'package:jobby_application/candidate/account/views/mange_cv_page.dart';
import 'package:jobby_application/candidate/account/views/privacy_and_policy_page.dart';
...
import 'package:jobby_application/candidate/account/views/share_with_your_friend_page.dart';
import 'package:jobby_application/candidate/account/views/skill_page.dart';
import 'package:jobby_application/candidate/account/views/term_of_service_page.dart';
import 'package:jobby_application/candidate/account/views/work_experience_page.dart';
import 'package:jobby_application/candidate/account/views/your_jobby_profile_page.dart';
import 'package:jobby_application/candidate/account/views/your_work_criteria_page.dart';
...
import 'package:jobby_application/candidate/quizz/question/views/succes_quiz_page.dart';
